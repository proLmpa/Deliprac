...
import com.example.baemin.service.product.ProductService
...
class ProductControllerTest {
    ...
    fun `PUT products - 200 with updated product`() {
        ...
        given(productService.update(storeId, productId, updateRequest, ownerPrincipal)).willReturn(updated)
    ...
    fun `PUT products - 409 when wrong owner`() {
        given(productService.update(storeId, productId, updateRequest, ownerPrincipal))
            .willThrow(IllegalStateException("Forbidden"))
